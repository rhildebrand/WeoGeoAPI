...
for fileName in os.listdir('tourKmls')[0:10]:
    ...
    try:                                                      #this block extracts the coordinates, the overlay tags, the names
        ...
        # DanDye changes on 4/6/2012
        #labelPositionX = float(CornerCoordList[0]) + .25*(float(longitude) - float(CornerCoordList[0]))
        labelPositionX = float(CornerCoordList[0]) + .5*(float(longitude) - float(CornerCoordList[0]))
        #labelPositionY = float(CornerCoordList[1]) + .2*(float(latitude) - float(CornerCoordList[1]))
        labelPositionY = float(CornerCoordList[1]) + .5*(float(latitude) - float(CornerCoordList[1]))
        ...
        altitude = 55000  # DanDye changes on 4/6/2012 hard-coded altitude
        heading = 0
        tilt = 0
